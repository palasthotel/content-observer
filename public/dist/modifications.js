...
/* harmony import */ var _emotion_is_prop_valid__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @emotion/is-prop-valid */ "./node_modules/@emotion/is-prop-valid/dist/is-prop-valid.browser.esm.js");
...
/***/ "./src/components/ModificationsList/ModificationsList.styles.ts":
/*!**********************************************************************!*\
  !*** ./src/components/ModificationsList/ModificationsList.styles.ts ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/components/ModificationsList/ModificationsList.tsx":
/*!****************************************************************!*\
  !*** ./src/components/ModificationsList/ModificationsList.tsx ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _hooks_use_modifications__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../hooks/use-modifications */ "./src/hooks/use-modifications.ts");
/* harmony import */ var _hooks_use_sites__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../hooks/use-sites */ "./src/hooks/use-sites.ts");
/* harmony import */ var _ModificationsList_styles__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ModificationsList.styles */ "./src/components/ModificationsList/ModificationsList.styles.ts");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/format.js");
/* harmony import */ var date_fns_locale__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! date-fns/locale */ "./node_modules/date-fns/locale/de.js");
...
const dateFormat = timestamp => {
  ...
  return (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(registrationDate, 'Pp', {
    locale: date_fns_locale__WEBPACK_IMPORTED_MODULE_4__.de
  });
};
const ModificationsList = () => {
  const styles = (0,_ModificationsList_styles__WEBPACK_IMPORTED_MODULE_2__.useStyles)();
  const [selectedSiteId, setSelectedSiteId] = (0,_hooks_use_sites__WEBPACK_IMPORTED_MODULE_1__.useSelectSite)();
  const sites = (0,_hooks_use_sites__WEBPACK_IMPORTED_MODULE_1__.useSites)();
  const [operationResultMessage, setOperationResultMessage] = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)("");
  const [rowOperationResult, setRowOperationResult] = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)({
    id: "",
    success: true
  });
  const {
    ...
    notify,
    applySince
  } = (0,_hooks_use_modifications__WEBPACK_IMPORTED_MODULE_0__.useModifications)(parseInt(selectedSiteId));
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("h1", {
      ...
      className: `tablenav top ${styles.tablenav}`,
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("select", {
        ...
        }), sites.map(site => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("option", {
          value: site.id,
          children: site.slug
        }))]
        ...
        disabled: selectedSiteId == "0",
        children: "Notify"
      }), operationResultMessage ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("p", {
        className: "description",
        children: operationResultMessage
      }) : null]
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("thead", {
        ...
        children: modifications.mods.map(mod => {
          ...
          return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("tr", {
            className: needApplyButton ? styles.firstRow : undefined,
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("td", {
              children: mod.type
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("td", {
              children: mod.content_type
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("td", {
              children: mod.content_id
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("td", {
              children: needApplyButton ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("button", {
                className: "button button-secondary button-small",
                onClick: () => handleApply(key, mod.modified),
                children: ["Apply ", dateFormat(mod.modified), " and newer ", showResult ? icon : null]
              }) : null
            })]
          }, key);
        })
      })]
    }), canLoadMore && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("button", {
      onClick: loadMore,
      children: "Load more"
    })]
  });
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ModificationsList);

/***/ }),

/***/ "./src/hooks/use-modifications.ts":
/*!****************************************!*\
  !*** ./src/hooks/use-modifications.ts ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   useModifications: () => (/* binding */ useModifications)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _store_modifications_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../store/modifications-store */ "./src/store/modifications-store.ts");
...
const useModifications = site_id => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    (0,_store_modifications_store__WEBPACK_IMPORTED_MODULE_1__.fetchModifications)({
      site_id,
      page
    }).then(response => {
      if (response.success) {
  ...
  return {
    ...
    fetch: async () => {
      const response = await (0,_store_modifications_store__WEBPACK_IMPORTED_MODULE_1__.fetchSiteModifications)(site_id);
    ...
    notify: async () => {
      return await (0,_store_modifications_store__WEBPACK_IMPORTED_MODULE_1__.notify)(site_id);
    },
    applySince: async since => {
      return (0,_store_modifications_store__WEBPACK_IMPORTED_MODULE_1__.applyModifications)(since);
    }
  };
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   useSelectSite: () => (/* binding */ useSelectSite),
/* harmony export */   useSites: () => (/* binding */ useSites)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _store_sites_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../store/sites-store */ "./src/store/sites-store.ts");


const useSites = () => {
  const [state, setState] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    (0,_store_sites_store__WEBPACK_IMPORTED_MODULE_1__.fetchSites)().then(setState);
  }, []);
  return state;
};
const useSelectSite = () => {
  ...
  const [state, setState] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)((_localStorage$getItem = localStorage.getItem(cacheKey)) !== null && _localStorage$getItem !== void 0 ? _localStorage$getItem : "0");
  return [state, id => {
...
/***/ "./src/store/modifications-store.ts":
/*!******************************************!*\
  !*** ./src/store/modifications-store.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   applyModifications: () => (/* binding */ applyModifications),
/* harmony export */   fetchModifications: () => (/* binding */ fetchModifications),
/* harmony export */   fetchSiteModifications: () => (/* binding */ fetchSiteModifications),
/* harmony export */   notify: () => (/* binding */ notify)
/* harmony export */ });
/* harmony import */ var _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/api-fetch */ "@wordpress/api-fetch");
/* harmony import */ var _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _global__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./global */ "./src/store/global.ts");


const fetchModifications = async (query = {}) => {
  const params = new URLSearchParams({
    ...query,
    ...(0,_global__WEBPACK_IMPORTED_MODULE_1__.getApiKey)()
  });
  return await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0___default()({
    path: "/content-sync/v1/modifications?" + params.toString()
  });
};
const fetchSiteModifications = site_id => {
  const params = new URLSearchParams({
    action: "content_observer_fetch_modifications",
    site_id: site_id.toString()
  });
  return fetch((0,_global__WEBPACK_IMPORTED_MODULE_1__.getAjaxUrl)() + "?" + params.toString(), {
    credentials: "include"
  }).then(res => res.json()).then(json => json).catch(_ => ({
    success: false,
    data: {
...
const notify = site_id => {
  ...
  return fetch((0,_global__WEBPACK_IMPORTED_MODULE_1__.getAjaxUrl)() + "?" + params.toString(), {
    credentials: "include"
  }).then(res => res.json()).then(json => json).catch(reason => ({
    success: false,
    data: {
...
const applyModifications = since => {
  const params = new URLSearchParams({
...
"use strict";
/*!*********************************************!*\
  !*** ./src/modifications/modifications.tsx ***!
  \*********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_ModificationsList_ModificationsList__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/ModificationsList/ModificationsList */ "./src/components/ModificationsList/ModificationsList.tsx");
...
window.document.addEventListener("DOMContentLoaded", () => {
  ...
  root.render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_components_ModificationsList_ModificationsList__WEBPACK_IMPORTED_MODULE_1__["default"], {}));
});
})();
